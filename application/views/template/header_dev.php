		...
		<header id="header">
			...
			<div class="container"> <!-- 1152 pixels Container -->
				...
				<div class="sixteen columns">
					...
					<!-- Logo -->
					<div id="logo">
						<a href="#"><img src="<?php echo base_url(); ?>static/images/logo.png" alt="logo"></a>
					</div>
						...
						<div id="primary-nav">
							...
							<ul id="main-menu">
								...
								<li>
									...
									<ul>
										<li><a href="<?php echo site_url("home/aboutus"); ?>">About Me</a></li>
										<li><a href="<?php echo site_url("home"); ?>">Resume</a></li>
									</ul>
								</li>
								
								<li><a href="<?php echo site_url("usa/first"); ?>">Tutorial</a>
									<ul>
										<li><a href="<?php echo site_url("usa/first"); ?>">Git</a>
											<ul>
												<li><a href="<?php echo site_url("usa/first"); ?>">Note</a></li>
												<li><a href="<?php echo site_url("home"); ?>">Video</a></li>
											</ul>
										</li>
										<li>
											<a href="<?php echo site_url("usa/first"); ?>">Codeigniter</a>
										</li>
										<li>
											<a href="<?php echo site_url("usa/first"); ?>">AWS</a>
										</li>
										<li>
											<a href="<?php echo site_url("usa/first"); ?>">Script Languages</a>
										</li>
									</ul>
								</li>

								<li><a href="<?php echo site_url("home"); ?>">What I learn</a>
									<ul>
